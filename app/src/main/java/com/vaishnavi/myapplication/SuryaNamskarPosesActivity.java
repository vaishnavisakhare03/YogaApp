...
public class SuryaNamskarPosesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        YogaPose pose3 = new YogaPose(R.drawable.Toe_touch, "Hand to foot pose or Hasta Padasana" , getResources().getString(R.string.tree_desc) , getResources().getString(R.string.tree_uses));
        ...
        YogaPose pose10 = new YogaPose(R.drawable.Toe_touch, " Hand to foot pose or Hasta Padasana" , getResources().getString(R.string.downward_desc) , getResources().getString(R.string.downward_uses));

...
public class SuryaNamskarPosesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        YogaPose pose2 = new YogaPose(R.drawable.backbendpose, "Raised arms pose or Hastauttanasana" , getResources().getString(R.string.camel_desc) , getResources().getString(R.string.camel_uses));
        ...
        YogaPose pose7 = new YogaPose(R.drawable.cobrapose, " Cobra pose or Bhujangasana" , getResources().getString(R.string.bridge_desc) , getResources().getString(R.string.bridge_uses));
        yogaPoseList.add(pose7);

        YogaPose pose8 = new YogaPose(R.drawable.downwarddogpose, "Mountain pose or Parvatasana" , getResources().getString(R.string.camel_desc) , getResources().getString(R.string.camel_uses));
        ...
        YogaPose pose11 = new YogaPose(R.drawable.backbendpose, "Raised Arms Pose or Hastauttanasana", getResources().getString(R.string.warrior_desc) , getResources().getString(R.string.warrior_uses));
